...
public class SavingThrowDisplay : MonoBehaviour
{
    ...
    public Character.AbilityScore abilityType;

    public SavingThrowAllocator allocator;
    ...
    void Update()
    {
        ...
        if (allocator.character.SavingThrowProficiencies[(int)abilityType] > 0)
        {
            abilityText.text += " +" + allocator.character.SavingThrowProficiencies[(int)abilityType].ToString();
        }
    }
}
